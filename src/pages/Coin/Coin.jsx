...
const Coin = () => {
  ...
  // Your fetchHistoricalData function
  const fetchHistoricalData = async () => {
    ...
    fetch(`https://api.coingecko.com/api/v3/coins/${coindID}/market_chart?vs_currency=${currency.name}&days=7&interval=daily`, options)
      .then(res => res.json())
